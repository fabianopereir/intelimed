...
public class PacienteDao implements InterfaceModelPaciente{
	...
	public Paciente buscarPacientePorNome(String nome) {
		...
		try {
			...
			Cursor c = db.query(NOME_TABELA, Paciente.colunas, Pacientes.NOME + "='" + nome + "'", null, null, null, null);
			...
			Log.e(CATEGORIA, "Erro ao buscar a paciente pelo nome: " + e.toString());
			return null;
		}
	...
	public Cursor getCursor(){
		try {
			...
			return db.query(NOME_TABELA, Paciente.colunas, null, null, null, null, null, null);
		} catch (SQLException e) {
	 ...
	 *  Utilizado pelo Content Provider de paciente
	 */
