package nutes.intelimed.test.diagnostic;
...
public class StructureQuestionnaireTest extends ActivityInstrumentationTestCase2<Login> {
	
	private StructureQuestionnaireDao dao;
	...
	public StructureQuestionnaireTest() {
		super("nutes.intelimed.activity.login",Login.class);
	}

	protected void setUp() throws Exception {
		super.setUp();
		dao = new StructureQuestionnaireDao(getActivity().getBaseContext());
	...
	public void test(){
		...
		sqt.setDescricao_no("Outlook");
		sqt.setCodeResposta(1);
		sqt.setDescricao_resposta("Sunny");
		estrutura.add(sqt);
		
		sqt = new StructureQuestionnaire();
		sqt.setDescricao_no("Outlook");
		sqt.setCodeResposta(2);
		sqt.setDescricao_resposta("Overcast");
		estrutura.add(sqt);
		
		sqt = new StructureQuestionnaire();
		sqt.setDescricao_no("Outlook");
		sqt.setCodeResposta(3);
		sqt.setDescricao_resposta("Rain");
		estrutura.add(sqt);
		
		sqt = new StructureQuestionnaire();
		sqt.setDescricao_no("Humidity");
		sqt.setCodeResposta(1);
		sqt.setDescricao_resposta("High");
		estrutura.add(sqt);
		
		sqt = new StructureQuestionnaire();
		sqt.setDescricao_no("Humidity");
		sqt.setCodeResposta(2);
		sqt.setDescricao_resposta("Normal");
		estrutura.add(sqt);
		
		sqt = new StructureQuestionnaire();
		sqt.setDescricao_no("Wind");
		sqt.setCodeResposta(2);
		sqt.setDescricao_resposta("Strong");
		estrutura.add(sqt);
		
		sqt = new StructureQuestionnaire();
		sqt.setDescricao_no("Wind");
		sqt.setCodeResposta(1);
		sqt.setDescricao_resposta("Weak");
		estrutura.add(sqt);
		
		List<StructureQuestionnaire> estrutura2 = dao.listarEstruturaQuestionario();
		for (int i = 0; i < estrutura.size(); i++) {
			estrutura.contains(estrutura2.get(i));
		}
	}
}
