...
grails.plugins.springsecurity.userLookup.userDomainClassName = 'intelimed.access.SecUser'
grails.plugins.springsecurity.userLookup.authorityJoinClassName = 'intelimed.access.SecUserRole'
