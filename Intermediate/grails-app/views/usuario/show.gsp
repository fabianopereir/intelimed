            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="usuario.tipoDeUsuario.label" default="Tipo De Usuario" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: usuarioInstance, field: "tipoDeUsuario")}</td>
